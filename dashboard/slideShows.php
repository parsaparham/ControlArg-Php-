                ...
                <div class="col-lg-12">
                    <div class="portlet box border shadow">
                        <div class="portlet-heading">
                            ...
                            <button onclick="location.href='slideShows_add1.php'" class="btn btn-success curve">ایجاد اسلایدشو جدید</button>
                        </div><!-- /.portlet-heading -->


                        <?php
                        $sql2="select * from slideShows";
                        $num2=$object->num($sql2);
                        if($num2==0){echo "شما تاکنون هیچ اسلایدشویی نداشته اید. جهت ایجاد اسلایدشو، گزینه ایجاد اسلایدشو جدید را انتخاب کنید. ";goto a;}
                        ...
                        <div class="portlet-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="data-table">
                                    ...
                                    <?php
                                    $sql4="select * from slideShows order by id desc";
                                    ...
                                    $image="../uploads/slideShows/".$id.".".$fileType;
                                        ...
                                        <tr>
                                            ...
                                            <td <?php echo $s; ?>><?php echo $date;  ?></td>
                                            <td <?php echo $s; ?>><?php echo $time;  ?></td>
                                            <td <?php echo $s; ?>><?php echo $id;  ?></td>
                                            <td <?php echo $s; ?>><?php echo $name;  ?></td>
                                            <td <?php echo $s; ?>> <img src="<?php echo $image ?>" width="50px" height="50px"></td>
                                            <td <?php echo $s; ?>><?php echo $priority;  ?></td>
                                            <td <?php echo $s; ?>><?php echo $n;  ?></td>
                                            <td <?php echo $s; ?>><a href="slideShows_edit1.php?id=<?php  echo $id; ?>"><span class="badge badge-warning">ویرایش</span></a></td>
                                            <td <?php echo $s; ?>><a href="slideShows_delete.php?id=<?php  echo $id; ?>"><span class="badge badge-danger">حذف</span></a></td>
                                        <?php
                                    }
                                    ?>
